...
const PopularContent = () => {
  const logos = [
    { src: logoSerieA, alt: "Serie A" },
    { src: logoLegaCalcio, alt: "Lega Calcio" },
    { src: logoEuropaLeague, alt: "UEFA Europa League" },
    { src: logoEredivisie, alt: "Eredivisie" },
    { src: logoMotoGP, alt: "MotoGP" },
    { src: logoSport1, alt: "Sport1" },
    { src: logoESPN, alt: "ESPN" },
    { src: logoSkySport, alt: "Sky Sport" },
    { src: logoBeINSports, alt: "beIN Sports" },
    { src: logoFoxSports, alt: "Fox Sports" },
    { src: logoBundesliga, alt: "Bundesliga" },
    { src: logoNBCSports, alt: "NBC Sports" },
  ];
